...
function checkOther(select) {
    var otherCropInput = document.getElementById("otherCropInput");
...
stateSelect.addEventListener("change", function() {
    ...
    populateDropdown(districtSelect, districts[selectedState]);
    mandalSelect.innerHTML = '<option value="" selected disabled>Select Mandal</option>';
    villageSelect.innerHTML = '<option value="" selected disabled>Select Village</option>';
});

districtSelect.addEventListener("change", function() {
    const selectedDistrict = districtSelect.value;
    populateDropdown(mandalSelect, mandals[selectedDistrict]);
    villageSelect.innerHTML = '<option value="" selected disabled>Select Village</option>';
});

mandalSelect.addEventListener("change", function() {
    const selectedMandal = mandalSelect.value;
    populateDropdown(villageSelect, villages[selectedMandal]);
});
